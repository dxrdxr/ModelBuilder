...
namespace Microsoft.OData.ModelBuilder.Conventions.Attributes
{
    ...
    internal class NullableContextAttributeEdmTypeConvention : AttributeEdmTypeConvention<StructuralTypeConfiguration>
    {
                                   ...
                                   Attribute attribute)
        {
            ...
            //
            // Only propigate Nullability if flag == 1 (not annotated)
            //
            ...
            foreach (var edmProperty in edmTypeConfiguration.Properties.ToArray())
            {
                ...
                //
                // Do not propigate if it is a value type
                //
                ...
                //
                // Only propigate the NullableContext to properties without a Nullable attribute
                //      
                ...
                //
                // Similar to EF Core, do not try to propigate nullability for generic properties, since calculating
